...
# pour changer les couleurs des bulles
def modification():
...
# Entry 2, pour écrire le mot de passe de l'utilisateur
...
# Label 3, du mot de passe 
label2 = Label(frame0, text=" Confirmation du Password : ", font="cursive")
label2.grid(row=2,column=0)

# Entry 3, pour écrire le mot de passe de l'utilisateur
password_con =  Entry(frame0, text="Your password", border = "5px" )
password_con.grid(row=1, column=1)
# Deuxième button pour annuler
btn = Button(frame0,text = "Annuler", command = quit)
btn.grid(row=3, column=1)

# conditions de mot de passe et email
